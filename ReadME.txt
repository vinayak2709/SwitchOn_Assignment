...
Instead of just 100 images whole continuous video can be monitored in the project (many continuous frames) and also Camera is needed.Saving lot of images is data consuming activity but can be done if required.(by "fourcc", videowrite in opnCv itself)
